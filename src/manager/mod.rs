...
use ui::controller::{control::Controller, model::ModelWindow};
use ui::{
...
impl Manager {
    pub fn new(cc: &eframe::CreationContext) -> Self {
        ...
        Manager {
            ...
            model_window: ModelWindow::default(),
            dataset_window: DatasetWindow::default(),
            session_window: SessionWindow::default(),
            node_view: NodesView { is_open: false },
            cost_view: CostsWindow::default(),
        }
    }
}
